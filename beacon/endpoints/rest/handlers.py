...
fhir_individuals_by_individual = generic_handler('fhir-biosamples' , fhir_individuals_proxy , rest_client.fetch_individuals_by_individuals , build_fhir_biosample_or_individual_response)
fhir_biosamples_by_biosample = generic_handler('fhir-biosamples' , fhir_biosamples_proxy , rest_client.fetch_biosamples_by_biosample , build_fhir_biosample_or_individual_response)